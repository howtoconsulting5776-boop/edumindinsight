  ...
  return (
    <div className="max-w-5xl mx-auto animate-pulse">
      <div className="mb-10">
        ...
        <div className="mt-2 h-4 w-64 rounded-xl bg-slate-100" />
      </div>
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-5 mb-10">
        {[0, 1, 2, 3].map((i) => (
          <div key={i} className="rounded-3xl bg-white p-7 shadow-xl shadow-slate-200/60 space-y-3">
      ...
      <div className="rounded-3xl bg-white p-7 shadow-xl shadow-slate-200/60 space-y-4">
